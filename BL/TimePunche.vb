...
#Region "Public Properties"
    ...
    Public Property DepartmentID() As Guid
        ...
        End Get
        Set(ByVal value As Guid)
            Dim deptsql As String = "SELECT Name FROM Department WHERE ID = '" & value.ToString & "'"
            Dim a As New SqlCeAdapter("TimeClock")
            DepartmentName = a.QueryDatabaseForScalar(deptsql)
            _DepartmentID = value
        End Set
    End Property
...
Public Class TimeInOut
    ...
    Private _JobDescriptionName As String
...
#Region "Public Properties"
    ...
    Public Property JobDescriptionID() As Guid
        ...
        End Get
        Set(ByVal value As Guid)
            Dim jdsql As String = "SELECT JobDescription FROM JobDescriptions WHERE ID = '" & value.ToString & "'"
            Dim a As New SqlCeAdapter("TimeClock")
            JobDescriptionName = a.QueryDatabaseForScalar(jdsql)
            _JobDescriptionID = value
        End Set
    End Property

    Public Property JobDescriptionName() As String
        Get
            Return _JobDescriptionName
        End Get
        Set(ByVal value As String)
            _JobDescriptionName = value
